...
@Composable
fun OnboardingContent2(navController: NavController, modifier: Modifier) {
    ...
    Column(
        ...
        Button(
            onClick = {
                navController.navigate(NavigationRoutes.ONBOARDING3) {
                    popUpTo(NavigationRoutes.ONBOARDING2) { inclusive = true }
                }
            },
