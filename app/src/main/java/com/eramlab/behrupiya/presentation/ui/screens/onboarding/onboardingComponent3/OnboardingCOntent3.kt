package com.eramlab.behrupiya.presentation.ui.screens.onboarding.onboardingComponent3
...
@Composable
fun OnboardingContent3(navController: NavController, modifier: Modifier) {
        ...
        Button(
            onClick = {
                navController.navigate(NavigationRoutes.HOME) {
                    popUpTo(NavigationRoutes.ONBOARDING3) { inclusive = true }
                }
            },
            ...
            Text(text = "Finish", fontSize = 22.sp, color = Color.White, fontWeight = FontWeight.Bold)
        }
